                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-3 animate" data-animate="fadeInUp">
                         ...
                         <div class="col-md-6 animate" data-animate="fadeInUp">
                                       <form method="get" action="deacc.php">
                                            <div class="input-field">
                                                <label for="deprel">Choose Relationship:</label>

                                                    <select name="deprel" id="deprel" class="form-control" style="color: black">
                                                    <option value="">....</option>
                                                    ...
                                                    <option value="Grand Father">Grand Mother</option>
                                            ...
                                            <div class="input-field">
                                                Full Name:
                                                <input type="text" class="form-control" name="depname" id="depname" required placeholder="last name, first name middle name">
                                            </div>
                                            <div class="input-field">
                                                <label for="perben">Choose Benefits Percentage:</label>

                                                    <select name="perben" id="perben" class="form-control" style="color: black">
                                                    <option value="">....</option>
                                            ...
                                            <button class="btn" type="submit" formaction="deacc.php">SAVE</button>
                                        </form>
