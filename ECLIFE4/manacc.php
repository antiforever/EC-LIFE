                                       ...
                                       <form method="get" action="macc.php">
                                            <div class="input-field">
                                                <label for="tamount">Choose Package Amount:</label>
                                                    ...
                                                    <option value="1300000">Php 1,300,000.00</option>
                                                    <option value="1500000">Php 1,500,000.00</option>
                                                    <option value="1800000">Php 1,800,000.00</option>
                                                    <option value="2000000">Php 2,000,000.00</option>
                                                    </select>
                                            </div>
                                            <div class="input-field">
